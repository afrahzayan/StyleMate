...
const CATALOG = {
  ...
  ageGroup: [
    { value: "Kids", label: "Kids", image: "StyleMate/onboarding/gender/boy" },
    { value: "Teen", label: "Teen", image: "StyleMate/onboarding/gender/girl" },
    { value: "Adult", label: "Adult" },
  ],
  occasion: [
    { value: "Casual", label: "Casual", image: "StyleMate/onboarding/occasion/casual" },
    { value: "Party", label: "Party", image: "StyleMate/onboarding/occasion/party" },
    { value: "Wedding", label: "Wedding", image: "StyleMate/onboarding/occasion/wedding" },
    { value: "Formal", label: "Formal", image: "StyleMate/onboarding/occasion/formal" },
    { value: "Festive", label: "Festive", image: "StyleMate/onboarding/occasion/festival" },
  ],
  dressCategory: [
